...
import sys
sys.path.append('/data/XiaolongWu/miccai24/RDN')
...
if __name__ == '__main__':
    model_xtrans = Head().cuda()
    fixed_img = torch.randn(1,1, 160, 192, 160).cuda()
    moving_img = torch.randn(1,1, 160, 192, 160).cuda()
    x, flow = model_xtrans(moving_img, fixed_img)
    print(x.shape)